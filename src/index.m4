...
<html lang="en">
    <head>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/fullPage.js/2.7.1/jquery.fullPage.min.css"></script>
    ...
    <body>
        ...
        <script type="text/javascript" language="javascript">
            ...
            $(document).ready(function() {
                $('#fullpage').fullpage({
                    anchors: ['contact_info', 'project', 'about'],
